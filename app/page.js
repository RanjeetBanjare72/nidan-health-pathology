...
const tests = [
  ...
  },
  {
    ...
    range:
      "Reference range age, sex aur laboratory ke hisab se vary karti hai.",
  },
  {
    icon: "🧪",
    name: "LFT",
  ...
  },
  {
    ...
    range:
      "Creatinine reference range lab, age aur sex ke hisab se vary karti hai.",
  },
  {
    icon: "🍬",
    name: "Blood Sugar",
    ...
    range:
      "Interpretation fasting/random status aur clinical context par depend karti hai.",
  },
  {
    icon: "📊",
    name: "HbA1c",
    ...
    range:
      "Result ko diabetes guidelines aur clinical context ke saath interpret kiya jata hai.",
  },
  {
    icon: "🦋",
    ...
    range:
      "TSH/T3/T4 reference intervals laboratory aur method ke hisab se vary karte hain.",
  },
  {
    icon: "❤️",
    name: "Lipid Profile",
    ...
    range:
      "Targets patient ke overall cardiovascular risk par depend kar sakte hain.",
  },
  {
    icon: "🧫",
    name: "Urine R/M",
    ...
    range:
      "Interpretation measured parameter aur laboratory method par depend karti hai.",
  },
];
...
export default function Home() {
  ...
  const calculateBP = () => {
    ...
    if (!systolic || !diastolic || sys <= 0 || dia <= 0) {
      setBpError(
        "Please valid Systolic aur Diastolic BP enter karein."
      );
    ...
    if (sys < 50 || sys > 300 || dia < 30 || dia > 200) {
      setBpError(
        "BP value expected range ke bahar hai. Value dobara check karein."
      );
    ...
    if (sys > 180 || dia > 120) {
      ...
      message = "Reading normal range mein hai.";
    }
  ...
  return (
    <main>
      ...
      >
        ...
        <div className="grid">
          {filteredTests.length > 0 ? (
            ...
            <p>
              Is search ke liye koi blood test nahi mila.
            </p>
          )}
        </div>
      </section>
      ...
      >
        ...
        <p>
          Laboratory reference ranges testing method,
          laboratory, age, sex, pregnancy aur clinical
          situation ke according alag ho sakti hain.
          Apni report par printed reference interval ko
          priority dein.
        </p>

        <div className="notice">
          ⚠️ Sirf ek abnormal value ke basis par khud
          diagnosis na karein. Report ko symptoms,
          medical history aur healthcare professional
          ki assessment ke saath interpret kiya jana
          chahiye.
        </div>
      </section>
      ...
      >
        ...
        <div className="miniGrid">
          ...
          <div className="tool bmiCalculator">
            ...
            <p>
              Apni height aur weight enter karke BMI
              calculate karein.
            </p>
          ...
          <div className="tool egfrCalculator">
            ...
            <p>
              2021 CKD-EPI Creatinine Equation se
            ...
            {egfr !== null && (
              <div className="egfrResult">
                ...
                <div className="egfrNote">
                  eGFR ek estimate hai. G1/G2 value
                  akeli CKD diagnosis establish nahi
                  karti. Clinical findings, urine
                  albumin aur repeat testing bhi
          ...
          <div className="tool bpCalculator">
            <span>❤️</span>

            <h3>Blood Pressure Checker</h3>

            <p>
              Apna Systolic aur Diastolic blood
              pressure enter karke BP category
              check karein.
            </p>
            ...
            {bpResult && (
              <div className="bpResult">
                ...
                <div className="bpDisclaimer">
                  Ek single BP reading se
                  hypertension diagnose nahi hota.
                  Diagnosis ke liye repeat
                  measurements aur healthcare
                  professional ka assessment
      ...
      >
        ...
        <div className="articleBox">
          <h3>
            CBC report kaise samjhein?
          </h3>

          <p>
            Hemoglobin, WBC, RBC aur platelet
            count ke basic meaning ko simple
        ...
        <div className="articleBox">
          <h3>
            LFT test kyun kiya jata hai?
          </h3>

          <p>
            Liver function tests mein commonly
            measured parameters aur unki general
            role ko samjhein.
          </p>
        </div>
        ...
        <div className="articleBox">
          <h3>
            Thyroid profile kya hai?
          </h3>

          <p>
            TSH, T3 aur T4 tests thyroid
            function assessment mein kaise use
      ...
      <section className="disclaimer">
        ...
        <p>
          NIDAN Health & Pathology Guide par di
          gayi information educational purpose
          ke liye hai. Yeh doctor ki consultation,
          diagnosis ya treatment ka replacement
          nahi hai. Kisi bhi medical decision ke
          liye qualified healthcare professional
          se salah lein.
        </p>
      </section>
      ...
      <footer>
        <div>
          ...
          <p>
            Health & Pathology Guide
          </p>
        </div>

        <p>
          © 2026 NIDAN. Educational health
          information.
        </p>
      </footer>
    </main>
